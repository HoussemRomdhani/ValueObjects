...
public enum Currency
{
    ...
    [Description("Bolivian Midol (funds code)")]
    BOV = 984,
    ...
    [Description("Unidad de Foment (funds code)")]
    CLF = 990,
    ...
    [Description("Unidad de Val or Real (UVR) (funds code)")]
    COU = 970,
